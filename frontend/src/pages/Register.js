...
import { Lightning, EnvelopeSimple, Lock, User, GoogleLogo, ArrowRight, Eye, EyeSlash, Moon, Sun } from '@phosphor-icons/react';
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-20">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="flex items-center justify-between mb-10">
            <Link to="/" className="flex items-center gap-3" data-testid="register-logo">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {error && (
                <div className="p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 text-sm" data-testid="register-error">
                  {error}
                </div>
              )}
            ...
            <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
              ...
              <Link to="/login" className="font-medium text-primary-600 dark:text-primary-400 hover:underline" data-testid="register-login-link">
                Sign in
              </Link>
            </p>
          </motion.div>
